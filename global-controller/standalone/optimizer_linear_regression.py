...
objective_function = "avg_latency"
...
if workload == 0:
    ...
    placement[0] = {'ingress_gw', 'productpage-v1', 'reviews-v3', 'details-v1'}
    placement[1] = {'ingress_gw', 'productpage-v1', 'details-v1'}
    ...
    MAX_LOAD = opt_func.get_max_load(NUM_REQUESTS)
    placement[0] = {'ingress_gw', 'productpage-v1', 'reviews-v3', 'details-v1'}
    placement[1] = {'ingress_gw', 'productpage-v1', 'reviews-v3', 'details-v1'}
    callgraph["A"] = {'ingress_gw': ['productpage-v1'], 'productpage-v1': ['reviews-v3'], 'reviews-v3':[]}
    callgraph["B"] = {'ingress_gw': ['productpage-v1'], 'productpage-v1': ['details-v1'], 'details-v1':[]}
...
if gurobi_model.Status != GRB.OPTIMAL:
    ...
    print(f"{cfg.log_prefix} ** Objective function: {objective_function}")
