...
class Span:
    ...
    def __str__(self):
        return f"SPAN,{self.trace_id},{self.svc_name},{self.get_class()},{self.method},{self.url},{self.cluster_id},{self.my_span_id},{self.parent_span_id},{self.load},{self.last_load},{self.avg_load},{self.rps},{self.st},{self.et},{self.rt},{self.call_size}"